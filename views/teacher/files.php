...
<div class="section-header">
    ...
    <a href="/teacher/files/upload" class="btn btn-primary">
        <i class="bi bi-upload me-2"></i>Завантажити файл
    </a>
</div>
...
<div class="filter-bar">
    <form method="GET" class="row g-3 flex-grow-1">
        ...
        <div class="col-md-4 d-flex gap-2">
            ...
            <a href="/teacher/files" class="btn btn-outline-secondary">Скинути</a>
        </div>
    </form>
</div>
...
<div class="table-responsive">
    <table class="table table-striped">
        ...
        <tbody>
            <?php if (empty($files)): ?>
                <tr>
                    <td colspan="5" class="text-center text-muted">Результати не знайдено</td>
                </tr>
            <?php else: ?>
                <?php foreach ($files as $file): ?>
                    <tr>
                        ...
                        <td>
                            <a href="/teacher/files/download/<?= $file['id'] ?>" 
                               class="btn btn-sm btn-primary" 
                               title="Завантажити"
                               target="_blank">
                                <i class="bi bi-download"></i>
                            </a>
                            <a href="/teacher/files/edit/<?= $file['id'] ?>" 
                               class="btn btn-sm btn-warning" 
                               title="Редагувати призначення">
                                <i class="bi bi-pencil"></i>
                            </a>
                            <a href="/teacher/files/delete/<?= $file['id'] ?>" 
