...
<div class="section-header">
    <h2>
        ...
        Редагувати призначення файлу
    </h2>
</div>

<div class="card mb-4">
    <div class="card-body">
        <h5 class="card-title mb-3">Інформація про файл</h5>
        <p><strong>Назва:</strong> <?= $this->e($file['original_name']) ?></p>
        <p><strong>Розмір:</strong> <?= $this->formatFileSize((int)$file['file_size']) ?></p>
        <p><strong>Завантажено:</strong> <?= date('d.m.Y H:i', strtotime($file['created_at'])) ?></p>
        <p><strong>Завантажив:</strong> <?= $this->e($file['first_name'] . ' ' . $file['last_name']) ?> (<?= $this->e($file['email']) ?>)</p>
    </div>
</div>

<form method="POST" action="/teacher/files/edit/<?= $file['id'] ?>">
                                ...
                                <tbody>
                                    <?php foreach ($students as $student): ?>
                                        <tr class="student-row" 
                                            data-name="<?= mb_strtolower($this->e($student['first_name'] . ' ' . $student['last_name'])) ?>"
                                            data-email="<?= mb_strtolower($this->e($student['email'])) ?>">
                                            <td>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="/teacher/files" class="btn btn-secondary">
