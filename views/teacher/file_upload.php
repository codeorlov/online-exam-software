...
$maxFileSizeMB = round((int)$settings->get('max_file_size', 10485760) / 1048576, 1);
...
<form method="POST" action="/teacher/files/upload" enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <small class="form-text text-muted">
                    Максимальний розмір файлу: <?= $maxFileSizeMB ?> MB. 
                    Дозволені типи: <?= $this->e($allowedTypes) ?>
                </small>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex gap-2">
        <button type="submit" class="btn btn-primary">
            <i class="bi bi-upload me-2"></i>Завантажити
        </button>
