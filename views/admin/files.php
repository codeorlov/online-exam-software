...
<div class="section-header">
    ...
    <a href="/admin/files/upload" class="btn btn-primary">
...
<div class="filter-bar">
    <form method="GET" class="row g-3 flex-grow-1">
        ...
        <div class="col-md-3">
            <select name="uploaded_by" class="form-select">
                ...
                <?php foreach ($teachers as $teacher): ?>
                    <option value="<?= $teacher['id'] ?>" <?= ($filters['uploaded_by'] ?? null) == $teacher['id'] ? 'selected' : '' ?>>
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="/admin/files" class="btn btn-outline-secondary">Скинути</a>
        </div>
    </form>
</div>
...
<?php if ($totalPages > 1): ?>
    <nav aria-label="Навігація по сторінкам">
        <ul class="pagination justify-content-center mt-4">
            <?php 
            $queryParams = [];
            if (!empty($filters['uploaded_by'])) $queryParams[] = 'uploaded_by=' . $filters['uploaded_by'];
